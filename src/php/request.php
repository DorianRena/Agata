...
if ($requesttype == "inscription") {
    ...
    $stmt = $db->prepare("
        INSERT INTO events (title, description, event_date, event_time, location, created_by, is_private)
        VALUES (:title, :description, :event_date, :event_time, :location, :created_by, :is_private)
    ");
